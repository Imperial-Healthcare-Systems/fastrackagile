...
insert into public.courses (slug,title,subtitle,mode,duration,schedule,summary,sort_order) values
 ...
 ('practical-scrum-interview-edge','Practical Scrum Interview Edge','Mock Practice Bootcamp','Online','Bootcamp','Mon–Fri · 10:15–11:30 AM IST','A focused bootcamp built around the exact interview questions you''ll face — scenario-based practice, personalized feedback, and confidence to walk in ready.',3),
